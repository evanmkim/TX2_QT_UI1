 ...
 ******************************************************************************/
class QtPreviewConsumerThread : public Thread
{
public:
    ...
    explicit QtPreviewConsumerThread(EGLDisplay display, EGLStreamKHR stream);
    explicit QtPreviewConsumerThread(EGLDisplay display, const std::vector<EGLStreamKHR>& streams,
                                   RenderLayout layout = LAYOUT_TILED,
                                   bool syncStreams = false);
    ~QtPreviewConsumerThread();
